...
class Permission(BaseModel):
    __tablename__ = 'bm_auth_permission'
...
class MidAdminAndRole(BaseModel):
    __tablename__ = 'bm_auth_mid_admin_role'
    __table_args__ = (
...
class MidPermissionAndRole(BaseModel):
    __tablename__ = 'bm_auth_mid_permission_role'
    __table_args__ = (
...
class ApiResource(BaseModel):
    __tablename__ = 'bm_auth_api_resource'
...
class RouteResource(BaseModel):
    __tablename__ = 'bm_auth_route_resource'
